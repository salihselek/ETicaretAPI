...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        {
            GoogleLoginCommandResponse response = await this._mediator.Send(googleLoginCommandRequest);
            return Ok(response);
        }
        ...
        {
            FacebookLoginCommandResponse response = await this._mediator.Send(facebookLoginCommandRequest);
            return Ok(response);
        }
