...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpGet("{Id}")]
        [AuthorizeDefination(Menu = AuthorizeDefinationConstants.Orders, ActionType = ActionType.Reading, Defination = "Get Order ById")]
        ...
        [AuthorizeDefination(Menu = AuthorizeDefinationConstants.Orders, ActionType = ActionType.Updating, Defination = "Complete Order")]
